    ...
    <section className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          <a
            href="#"
            className="group flex items-center gap-4 p-6 rounded-xl bg-[#111] border border-white/5 hover:border-[#5865F2]/50 transition-all"
          >
            <div className="w-12 h-12 rounded-lg bg-[#5865F2]/20 flex items-center justify-center group-hover:bg-[#5865F2]/30 transition-colors">
          ...
          <a
            href="#"
            className="group flex items-center gap-4 p-6 rounded-xl bg-[#111] border border-white/5 hover:border-red-500/50 transition-all"
          >
